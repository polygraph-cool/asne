...
function init(mapData,latLongData,newsIDLocation,newsIDInfo,top_3_data) {
  ...
  var top3Map = d3.map(top_3_data,function(d){ return d.Organization.toLowerCase(); });
  ...
  function buildChart(){
    ...
    var chartDivContainer = container
      .append("div")
      .attr("class","swarm-leader-chart-container")
    ...
    var totalExtent = d3.extent(dataToMap,function(d){return +d.total_num})
